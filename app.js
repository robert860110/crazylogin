...
// var rtg = url.parse('redis://redistogo:28484176580357efb673915fa53f344b@catfish.redistogo.com:10486/');
...
app.use(expressSession({ store: new RedisStore({ client: redis }), secret: 'Some Secret!!!' }));
app.use(logger('dev'));
app.use(bodyParser());
